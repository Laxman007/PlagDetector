        ...
        return (
            <>
                <Container>
                    ...
                    <SectionContainer>
                        <BoxContainer>
                            <Box severity={this.props.literalSimValue.toPrecision(3)}>{(this.props.literalSimValue.toPrecision(3) * 100).toFixed(1)}%</Box>
                            <Subtitle>Literal Sim Value</Subtitle>
                            <Description>{LITERAL}</Description>
                        </BoxContainer>
                        <BoxContainer>
                            <Box severity={this.props.identifierSimValue.toPrecision(3)}>{(this.props.identifierSimValue.toPrecision(3) * 100).toFixed(1)}%</Box>
