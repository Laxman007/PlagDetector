...
describe('JS Detection Engine', function () {
    ...
    it("Testing 1", () => {
        ...
        let file_A = fs.readFileSync('/Users/brianward/Desktop/Northeastern/softwareDev/termProject/Team-07/back-end/src/test/model/jsSample.js', 'utf-8');
        let file_B = fs.readFileSync("/Users/brianward/Desktop/Northeastern/softwareDev/termProject/Team-07/back-end/src/test/model/jsSample.js", 'utf-8');
